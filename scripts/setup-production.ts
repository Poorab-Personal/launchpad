...
async function main() {
  ...
  const teamMembersId = await createTable('Team Members', [
    ...
    ss('Role', ['Designer', 'Senior Designer', 'CSM', 'Account Creator', 'Admin']),
    cb('Active'),
  ]);
  ...
  const workflowTemplatesId = await createTable('Workflow Templates', [
    ...
    ss('Assigned Role', ['Designer', 'Senior Designer', 'CSM', 'Account Creator']),
