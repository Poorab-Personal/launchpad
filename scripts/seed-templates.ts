...
const SEED_DATA: TemplateRow[] = [
  ...
  { 'Workflow Key': 'B2B-Keyes', Stage: 'Getting Started', 'Stage Order': 1, 'Task Title': 'Start Your Trial', 'Task Type': 'Client', 'Task Order': 2, 'Visible To Client': true, 'Initial Status': 'Active', 'Depends On': '', 'Attachment Type': 'None', Instructions: 'Follow the instructions to activate your trial account.' },
  { 'Workflow Key': 'B2B-Keyes', Stage: 'Getting Started', 'Stage Order': 1, 'Task Title': 'Schedule Your Onboarding Call', 'Task Type': 'Client', 'Task Order': 3, 'Visible To Client': true, 'Initial Status': 'Active', 'Depends On': '', 'Attachment Type': 'Embed', Instructions: 'Book your onboarding call.' },
  { 'Workflow Key': 'B2B-Keyes', Stage: 'Prepare for Onboarding', 'Stage Order': 2, 'Task Title': 'Create Customer Account', 'Task Type': 'Team', 'Task Order': 1, 'Visible To Client': false, 'Initial Status': 'Draft', 'Depends On': '', 'Attachment Type': 'None', Instructions: 'Create the agent app.rejig.ai account using their roster email.' },
  ...
  { 'Workflow Key': 'B2B-Keyes', Stage: 'Prepare for Onboarding', 'Stage Order': 2, 'Task Title': 'Mark Onboarding Call Complete', 'Task Type': 'Team', 'Task Order': 5, 'Visible To Client': false, 'Initial Status': 'Draft', 'Depends On': '', 'Attachment Type': 'None', Instructions: 'Mark complete after the onboarding call.' },
  ...
  { 'Workflow Key': 'B2B-BW', Stage: 'Prepare for Onboarding', 'Stage Order': 2, 'Task Title': 'Create Customer Account', 'Task Type': 'Team', 'Task Order': 1, 'Visible To Client': false, 'Initial Status': 'Draft', 'Depends On': '', 'Attachment Type': 'None', Instructions: 'Create the agent app.rejig.ai account using their roster email.' },
  ...
  { 'Workflow Key': 'B2B-BW', Stage: 'Prepare for Onboarding', 'Stage Order': 2, 'Task Title': 'Mark Onboarding Call Complete', 'Task Type': 'Team', 'Task Order': 5, 'Visible To Client': false, 'Initial Status': 'Draft', 'Depends On': '', 'Attachment Type': 'None', Instructions: 'Mark complete after the onboarding call.' },
