...
const SEED_DATA: TemplateRow[] = [
  ...
  { 'Workflow Key': 'B2B-Keyes', Stage: 'Getting Started', 'Stage Order': 1, 'Task Title': 'Capture Payment Method', 'Task Type': 'Client', 'Task Order': 2, 'Visible To Client': true, 'Initial Status': 'Draft', 'Depends On': 'Confirm Your Information', 'Attachment Type': 'Payment Setup', Instructions: "Add a payment method to start your free trial. You won't be charged until your onboarding call is complete." },
